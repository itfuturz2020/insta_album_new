...
class GuestPortfolioImagesComponent extends StatefulWidget {
  ...
  @override
  _GuestPortfolioImagesComponentState createState() => _GuestPortfolioImagesComponentState();
}

class _GuestPortfolioImagesComponentState extends State<GuestPortfolioImagesComponent> {
              ...
              children: <Widget>[
                ClipRRect(
                  ...
                  child: widget.albumData["Image"] != null
                    ...
                    image: "${cnst.ImgUrl}${widget.albumData["ImageThumb"]}",
                    fit: BoxFit.cover,
